...
$LocalPath = 'C:\\fslogix'
$WVDflogixURL = 'https://raw.githubusercontent.com/GlenFawkner/Azure_Public/main/AIB/Installs/FSLogixSetup.ps1'
...
Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Force -Verbose .\\FSLogixSetup.ps1 -ProfilePath \\wvdSMB\wvd -Verbose 
