...
# instrumentation
$osOptURL = 'https://raw.githubusercontent.com/GlenFawkner/Azure_Public/main/AIB/Installs/Optimize_OS_for_AVD.ps1'
$osOptURLexe = 'Optimize_OS_for_AVD.ps1'
...
$updatePath= "C:\optimize\Virtual-Desktop-Optimization-Tool-main\Optimize_OS_for_AVD.ps1"
...
# .\optimize -WindowsVersion 2004 -Verbose
 .\Optimize_OS_for_AVD.ps1 -Optimizations  All -Verbose -AcceptEula
